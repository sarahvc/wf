...
class Menu extends Component {
    render() {
        const workClass = !this.props.active?'nav-link active position-relative': 'nav-link';
        const aboutClass = this.props.active?this.props.active==='about'?'nav-link active position-relative':'nav-link':'nav-link';
        const resumeClass = this.props.active?this.props.active==='resume'?'nav-link active position-relative':'nav-link':'nav-link';
