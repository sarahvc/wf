        ...
        return (
            <form className='artx-subscribe-form mx-auto'>
                <div className="form-group text-center">
                    <label className='artx-type-tw artx-gradient-text mb-4' htmlFor='subscribeEmail'>Subcribe to the ARTX email list to get updates on Decentralism art auctions and ARTX airdrop!</label>
