...
const Dorm = () => (
    <div className='fw-dorm'>
        <Menu main={false}/>
        <main>
            <Overview title='MAKING THE DORM HOMEY' quote="I'd so touched to konw that my child is being taken care of." source='--- Professor' summary={[' ',<strong>as</strong>, ' ']} myrole={[' ',<strong>aa</strong>, ' ']} type='Course Project. Responsive web.' duration='3 weeks.' members='Yujun Li.'/>
            <div className='container'>
                ...
                <h3>FINAL DESIGN</h3>
                <iframe width="560" height="315" title='mobile version demo' src="https://www.youtube.com/embed/pmCXO38TFZ0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
